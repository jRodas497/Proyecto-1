...
public class AgregarProfesor extends javax.swing.JFrame {
    ...
    public void agregar(){
        ...
        if (genero) {
            if(listas.controladorUsuario.addProfesor(number, "1234", nombre, "", "M", 2)){
            mensaje("Se agrego al profesor " + nombre + " correctamente!");
            dispose();
            }else{
            ...
            if(!listas.controladorUsuario.addProfesor(number, "1234", nombre, "", "F", 2)){
            mensaje("Se agrego al profesor " + nombre + " correctamente!");
            dispose();
            }else{
                mensaje("Se agrego al profesor " + nombre + " correctamente!");
